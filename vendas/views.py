...
def adicionar_produto_venda(request):
    ...
    try:
        ...
        # 💥 CORREÇÃO 1: Garante que a venda é salva após o item ser criado/atualizado
        venda.valor_total = venda.calcular_total() # Recalcula
        venda.save() # Salva o novo total no banco
...
def remover_produto_venda(request):
    ...
    try:
        ...
        # 💥 CORREÇÃO 2: DELETA o item
        item.delete() 
        
        # 💥 CORREÇÃO 3: Atualiza e SALVA o valor total da venda
